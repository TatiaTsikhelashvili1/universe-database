...
--
-- Name: constellating_group; Type: TABLE; Schema: public; Owner: freecodecamp
--
...
SELECT pg_catalog.setval('public.constellating_group_constellating_group_id_seq', 4, true);
